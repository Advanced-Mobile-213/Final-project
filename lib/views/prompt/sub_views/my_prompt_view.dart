...
class MyPromptView extends StatefulWidget {
  const MyPromptView({super.key});

  @override
  State<MyPromptView> createState() => _MyPromptViewState();
}

class _MyPromptViewState extends State<MyPromptView> {
  String query = '';
    ...
    return Expanded(
      child: Column(
        children: [
          ...
          Gap(spacing[3]),
          PromptList(isPublic: false, query: query),
        ],
      ),
    );
  }
