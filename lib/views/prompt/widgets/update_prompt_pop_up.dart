...
class UpdatePromptPopUpDialog extends StatefulWidget{
  ...
  @override
  State<UpdatePromptPopUpDialog> createState() => _UpdatePromptPopUpDialogState();
}
...
class _UpdatePromptPopUpDialogState extends State<UpdatePromptPopUpDialog> {
  ...
  final TextEditingController _nameInputFieldController = TextEditingController(text: "This is name of prompt");
